<template>
    <div v-if="!seenPatchNotes" id="patch-notes" class="text-secondary absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-lg rounded-sm p-5 bg-zinc-700">
        ...
        <Button text="Close" :selected="true" @clicked="closePatchNotes" class=" rounded-md bg-secondary p-2 px-5 text-black absolute left-[75%] bottom-6"/>
    </div>
</template>
