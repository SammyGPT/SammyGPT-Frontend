...
<template class="h-fit">
    <div id="examples" class="h-fit font-[Montserrat]">
        ...
        <div id="contianer" class="flex justify-center gap-4 mt-[5vh] h-fit">
            ...
            <div class="text-box-container w-[20%] self-center bg-transparent flex flex-col h-[23rem] gap-4">
                <span class="material-symbols-outlined dark:text-secondary text-primary mx-auto">warning</span>
                <h3 class=" w-full text-center dark:text-secondary text-primary text-[1.2rem]">Limitations</h3>
                <p class="text-box dark:text-secondary text-primary w-full text-center dark:bg-gray-700 bg-light-background h-fit p-4 shadow rounded-md">May occasionally generate incorrect information</p>
                <p class="text-box dark:text-secondary text-primary w-full text-center dark:bg-gray-700 bg-light-background h-fit p-4 shadow rounded-md">May occasionally produce biased content</p>
                <p class="text-box dark:text-secondary text-primary w-full text-center dark:bg-gray-700 bg-light-background h-fit p-4 shadow rounded-md">Limited knowledge of world and events after February 2022</p>    
            </div>
        </div>
    </div>
</template>
