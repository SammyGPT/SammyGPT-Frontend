    ...
    <div id="examples" class="h-fit font-[Montserrat]">
        ...
        <div id="contianer" class="flex justify-center gap-4 mt-[5vh] h-fit">
            <div class="text-box-container w-[20%] self-center bg-transparent flex flex-col h-[23rem] gap-4">
                ...
                <h3 class=" w-full text-center dark:text-secondary text-primary text-md">{{ $t("example-header") }}</h3>
            ...
            <div class="text-box-container w-[20%] self-center bg-transparent flex flex-col h-[23rem] gap-4">
                ...
                <h3 class=" w-full text-center dark:text-secondary text-primary text-md">{{ $t("capabilities-header") }}</h3>
            ...
            <!-- <div class="text-box-container w-[20%] self-center bg-transparent flex flex-col h-[23rem] gap-4">
                ...
                <h3 class=" w-full text-center text-secondary text-md">Disclaimer</h3>
            ...
            <div class="text-box-container w-[20%] self-center bg-transparent flex flex-col h-[23rem] gap-4">
                ...
                <h3 class=" w-full text-center dark:text-secondary text-primary text-md">{{ $t("benefits-header") }}</h3>
